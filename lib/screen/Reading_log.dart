...
//////صفحة سجل القراءة
class ReadingLog extends StatefulWidget {
  const ReadingLog({Key? key}) : super(key: key);
  static const screenRoute = '/CustomerListPage';

  @override
  _ReadingLogState createState() => _ReadingLogState();
}

class _ReadingLogState extends State<ReadingLog> {
  // All journals
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: new InputDecoration(hintText: 'عدد القراءات'),
                      ...
                      child: Row(
                        children: [
                          IconButton(
                            ...
                            color: Color.fromARGB(255, 25, 153, 53),
